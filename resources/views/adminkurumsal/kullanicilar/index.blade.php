            ...
            <table class="table table-bordered data-table">
                ...
                @foreach($kullanicilar as $kullanici)
                    ...
                    <tr class="gradeX">
                        ...
                        @if (Auth::id() == $kullanici->id)
                            <td class="center">
                                Silinemez
                            </td>
                        @else
                        {!! Form::model($kullanici,['route'=>['kullanici.sil',$kullanici->id],'method'=>'DELETE']) !!}

                        <td class="center">

                            <button type="submit"  class="btn btn-danger btn-mini" onclick="return window.confirm('Silmek istediğinize eminmisiniz?');">Sil</button>
