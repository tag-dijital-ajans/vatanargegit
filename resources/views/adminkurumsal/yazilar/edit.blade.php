            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="kategori" class="span11">
                                <option value="{{$yazi->kategorisi->id}}" selected>{{$yazi->kategorisi->kategori_baslik}}</option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="icerik" class="span11">{!! $yazi->icerik !!}{{-- {!! $yazi->icerik !!}}Bu şekilde parantez kullanılırsa html kodları temizlenmez.--}}</textarea>
                        </div>{{--{{$yazi->icerik}} bu şekilde kullanılırsa html kodları temizlenir. --}}
                    </div>
